...
const UI_ENV = {
    title: 'Théologie Familière et autres écrits de Saint-Cyran',
    canonical: 'https://theologie-familiere.sacy.be',
    dataBasePath:'',
    uiPath: 'ui',
    bookSelectorLabel: 'Part.',
    chapterSelectorLabel: 'Ch:',
    sites,
    links: [
        {
            title: 'rapporter une erreur',
            url: 'https://github.com/breviaire-pr/theologie-familiere-saint-cyran/issues'
        },
        {
            title: 'code source du site web',
            url: 'https://github.com/breviaire-pr/theologie-familiere-saint-cyran'
        },
        {
